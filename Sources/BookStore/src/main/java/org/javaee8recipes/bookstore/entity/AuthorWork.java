...
public class AuthorWork implements Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE,
            generator = "author_work_s_generator")
    @SequenceGenerator(name = "author_work_s_generator", sequenceName = "author_work_s", allocationSize = 1)
    ...
    public String toString() {
        return "org.javaeerecipes.chapter09.entity.AuthorWork[ id=" + id + " ]";
    }
