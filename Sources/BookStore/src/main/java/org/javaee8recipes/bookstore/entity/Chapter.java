...
public class Chapter implements Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE,
            generator = "chapter_s_generator")
    @SequenceGenerator(name = "chapter_s_generator", sequenceName = "chapter_s", allocationSize = 1)
    ...
    public String toString() {
        return "org.javaeerecipes.chapter09.entity.Chapter[ id=" + id + " ]";
    }
