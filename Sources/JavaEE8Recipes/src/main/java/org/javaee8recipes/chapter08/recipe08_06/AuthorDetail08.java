...
@Entity
public class AuthorDetail08 implements Serializable {
    ...
    @ManyToOne
    private Author08 authorId;

    public AuthorDetail08() {
    }

    public AuthorDetail08(BigDecimal id) {
        this.id = id;
    }
    ...
    public Author08 getAuthorId() {
        return authorId;
    }

    public void setAuthorId(Author08 authorId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AuthorDetail08)) {
            return false;
        }
        AuthorDetail08 other = (AuthorDetail08) object;
