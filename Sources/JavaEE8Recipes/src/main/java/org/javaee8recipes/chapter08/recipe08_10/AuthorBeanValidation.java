...
import org.javaee8recipes.chapter08.recipe08_07.AuthorDetail;
...
public class AuthorBeanValidation implements Serializable {
    ...
    public AuthorBeanValidation() {
    }

    public AuthorBeanValidation(BigDecimal id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        AuthorBeanValidation other = (AuthorBeanValidation) object;
    ...
    public String toString() {
        return "org.javaeerecipes.chapter08.entity.recipe08_06.AuthorBeanValidation[ id=" + id + " ]";
    }
