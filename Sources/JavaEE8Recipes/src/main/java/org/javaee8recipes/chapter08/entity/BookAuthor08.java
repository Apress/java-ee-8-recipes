...
public class BookAuthor08 implements Serializable {
    ...
    public BookAuthor08(BigDecimal id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        BookAuthor08 other = (BookAuthor08) object;
    ...
    public String toString() {
        return "org.javaeerecipes.chapter08.entity.BookAuthor08[ id=" + id + " ]";
    }
