...
package org.javaee8recipes.jpa.entity;
...
@SqlResultSetMapping(name="authorBooks",
        entities= {
            @EntityResult(entityClass=org.javaee8recipes.jpa.entity.Book.class, fields={
                @FieldResult(name="id", column="BOOK_ID"),
                @FieldResult(name="title", column="TITLE")
            }),
            @EntityResult(entityClass=org.javaee8recipes.jpa.entity.BookAuthor.class, fields={
...
public class BookAuthor implements Serializable {
    ...
    public String toString() {
        return "org.javaeerecipes.chapter09.entity.BookAuthor[ id=" + id + " ]";
    }
