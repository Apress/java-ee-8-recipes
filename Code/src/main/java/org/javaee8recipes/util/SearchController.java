...
import org.javaee8recipes.chapter06.AuthorController;
...
public class SearchController implements java.io.Serializable {
    ...
    public String searchAuthors(List authorList){
        ...
        List <org.javaee8recipes.chapter06.Author> tempList = authorList;
       
        for (org.javaee8recipes.chapter06.Author author: tempList){
